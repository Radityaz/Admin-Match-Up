          ...
          <p>Tampilan Peta</p>
            ...
            <form class="w-50 pt-3" action="/tambahpeta/store" method="post">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="Harga" name="harga_sewa_lokasi" placeholder="Masukkan Harga Sewa..." style="border: 3px solid #FF8A35" oninput="formatCurrency(this)" required>
              </div>
              <div class="mb-3">
